...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: "pnpm exec vite preview --host 127.0.0.1 --port 4173 --strictPort", url: "http://127.0.0.1:4173", env: { MONITOR_PROXY_TARGET: "http://127.0.0.1:4311" }, reuseExistingServer: false },
  ],
});
